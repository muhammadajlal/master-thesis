...
def main() -> None:
    ...
    ax_cer.set_title(r"H1 multimodal CER vs $\lambda_{\mathrm{ctc}}$ (private word)", fontsize=12)
    ax_wer.set_title(r"H1 multimodal WER vs $\lambda_{\mathrm{ctc}}$ (private word)", fontsize=12)
