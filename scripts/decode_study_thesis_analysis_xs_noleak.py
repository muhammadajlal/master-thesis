...
RESULT_DIRS = {
    "hybrid": BASE / "results/hwr2/decode_study_xs_full_hybrid_noleak",
    "ar": BASE / "results/hwr2/decode_study_xs_full_ar_noleak",
    "rewi_ctc": BASE / "results/hwr2/decode_study_rewi_ctc_noleak",
}
